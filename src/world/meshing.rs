...
mod tests {
    ...
    fn test_cross_chunk_border_face_culling() {
        ...
        let mesh_with_neighbors = build_chunk_mesh_with_neighbors(&chunk, None, &neighbors);
    ...
    fn test_cross_chunk_border_culling_all_six_faces() {
        ...
        let mesh = build_chunk_mesh_with_neighbors(&chunk, None, &neighbors);
    ...
    fn test_cross_chunk_border_partial_neighbor() {
        ...
        let mesh_all = build_chunk_mesh_with_neighbors(&chunk, None, &all_neighbors);
        let mesh_one = build_chunk_mesh_with_neighbors(&chunk, None, &one_neighbor);
