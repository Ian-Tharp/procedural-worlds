        ...
        4 => {
            ...
            for y in 0..ts {
                for x in 0..ts {
                    ...
                    let ripple =
                        ((x as f32 * 0.7 + y as f32 * 0.3) * 6.2832 / period).sin() * 0.5 + 0.5;
        ...
        16 => {
            ...
            for y in 0..ts {
                for x in 0..ts {
                    ...
                    let wave =
                        ((x as f32 * 0.75 + y as f32 * 0.65) * 6.2832 / period).sin() * 0.5 + 0.5;
                    // Secondary subtle wave for complexity
                    let wave2 = ((x as f32 * 0.3 - y as f32 * 0.9) * 6.2832 / (period * 2.5)).sin()
                        * 0.15
                        + 0.5;
